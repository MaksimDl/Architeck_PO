...
class RobotApi(object):
    ...
    def add_robot(self, body, **kwargs):  # noqa: E501
        ...
        :param Robot body: Создание нового робота в базе (required)
        :return: Robot
    ...
    def delete_robot(self, robot_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int robot_id: ID робота (required)
        :param str robot_id:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def get_robot_by_id(self, robot_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int robot_id: Идентификатор робота (required)
        :return: Robot
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_robot(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Robot body: Обновить существующего робота в базе (required)
        :return: Robot
                 If the method is called asynchronously,
                 returns the request thread.
        """
