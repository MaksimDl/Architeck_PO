...
class GroupApi(object):
    ...
    def add_group(self, body, **kwargs):  # noqa: E501
        ...
        :param Group body: Создать новую группу в базе (required)
        :return: Group
    ...
    def delete_group(self, group_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int group_id: ID пользователя (required)
        :param str group_id:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def get_group_by_id(self, group_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int group_id: Идентификатор группы (required)
        :return: Group
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_group(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Group body: Обновить существующую группу в базе (required)
        :return: Group
                 If the method is called asynchronously,
                 returns the request thread.
        """
