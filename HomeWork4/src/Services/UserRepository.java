...
public class UserRepository implements IUserRepo {
    ...
    private UserRepository() {
        ...
        clients.add(new User(1, "Ivan", "1111".hashCode(), 2, 0));
        clients.add(new User(2, "Vasiliy", "2222".hashCode(), 3, 0));
        clients.add(new User(3, "Fedor", "3333".hashCode(), 4, 0));
        clients.add(new User(4, "Grigoriy", "4444".hashCode(), 5, 0));
    }
    ...
    public int create(String userName, int passwordHash, long cardNumber) throws RuntimeException {
        ...
        User client = new User(id, userName, passwordHash, cardNumber, id);
